        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myDefaultNavbar1" >
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="reportperbenua.php">Report Per Benua</a></li>
                    ...
                    <div class="row">
                        <div class="col-xs12">
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                $sql = "SELECT * FROM buyer ORDER BY benua ASC";
                                ...
                                while($data = mysql_fetch_assoc($hasil_sql)) {
                                    ...
                                    echo "<td bgcolor='#FFE8E8' align='center'>$data[benua]</td>";
                            ...
                            <table id="example" class="table table-striped table-bordered dt-responsive nowrap text-center" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <!--th>Check</th-->

                                    <th class="text-center">Benua</th>
                                ...
                                <tbody>
                                <?php
                                $sql2 = "SELECT benua, COUNT(benua) AS TOTAL FROM buyer GROUP BY benua ORDER BY benua ASC";
                                ...
                                {
                                    echo"<tr><td>$data2[benua]</td><td align='center'>$data2[TOTAL]</td></tr>";

                                    $total_jendral = $total_jendral + $data2[TOTAL];
                                }



                                //echo"<tr><td><b>Total Benua Visitor</b></td><td align='center'><b>$total</b></td></tr>";
                                echo"<tr><td><b>Total Benua Visitor</b></td><td align='center'><b>$total</b></td></tr>";
