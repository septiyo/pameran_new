...
<form method="post" action="subhanallah.php">
 ...
 <tr>
    <th colspan="9" align="center">Tabel Hasil Pameran Per Benua</th>
 </tr>
...

  {
	...
	echo "<tr>";
	 ...
	 # echo "<td align='center'><input type='checkbox' name='ID[]' value='$data[ID]'></td>";
	  ...
	  echo "<td align='center' bgcolor='#FFE8E8'>$data[benua]</td>";
...
<tr>
  ...
  <!--td colspan="9" align="right"><input type="submit" value="HAPUS" name="HAPUS" /></td-->
	<td colspan="6" align="right"><b>Total Visitor</b></td><td colspan="2"><b><?php echo $total2; ?></b></td>
</tr>
